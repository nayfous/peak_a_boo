...
class MyApp(Ui_MainWindow, QMainWindow):
    ...
    def data_plot(self, filepath):
        ...
        self.ax1f1.plot(datax, data.CFP.tolist(), label="CFP", marker="o", markevery=200)
        self.ax1f1.plot(datax, data.YFP.tolist(), label="YFP", marker="s", markevery=200)
...
class MyToolbar(NavigationToolbar):
    def __init__(self, figure_canvas, parent= None):
        self.toolitems = (('Home', 'Lorem ipsum dolor sit amet', 'home', 'home'),
            ...
            ('print', 'print plot', "U:\programma\print", 'print_plot'),
            ('delete', 'delete plot', 'U:\programma\deleter', 'delete_plot')
            )
